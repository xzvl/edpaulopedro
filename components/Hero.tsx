export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-24 overflow-hidden">
      <div className="absolute inset-0 flex items-center justify-center z-0 pointer-events-none select-none hero-fade-down" style={{ animationDelay: '0ms', animationDuration: '1.2s' }}>
      ...
      <div className="relative z-10 w-full max-w-container-max px-6 md:px-margin-desktop text-center">
        <div className="mb-4 inline-flex items-center gap-2 px-4 py-1 rounded-full border border-cyber-red/30 bg-cyber-red/5 hero-fade-down" style={{ animationDelay: '0ms' }}>
        ...
        <h1 className="font-display-xl text-headline-lg-mobile md:text-display-xl mb-6 text-on-surface hero-fade-up" style={{ animationDelay: '200ms' }}>
          Hello, I&apos;m&nbsp;
        ...
        <p className="font-body-lg text-body-lg text-on-surface-variant max-w-2xl mx-auto mb-12 hero-fade-up" style={{ animationDelay: '400ms' }}>
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-6 hero-fade-up" style={{ animationDelay: '600ms' }}>
          <a
      ...
      <div className="absolute bottom-12 left-1/2 -translate-x-1/2 animate-bounce opacity-30 hero-fade-up" style={{ animationDelay: '900ms' }}>
